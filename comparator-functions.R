...
get.mtpi.next.dose = function(ntot,ndlt,target=0.3,delta=0.07){
...
simulate.mtpi.trial = function(dlt.probs,start.dose=1,cohort.size=3,ncohorts=12,min.esc.size=1,target=0.3,threshold=0.975,delta=0.07){
...
get.skeleton <- function(ndose, target=0.3, delta=0.07, prior.best=ceiling((ndose+1)/2)){
